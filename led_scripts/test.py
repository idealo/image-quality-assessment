...
def main():
    ...
    settings = {
            ...
            "color-temp": tuple(range(2200, 7000, 500)) + (4600,),
    ...
    total_combos = len(autobal_combos) + len(all_combos)
    num_completed = 1
    enable_auto_white_balance()
    for combo in autobal_combos:
        print("#"*40)
        time_remaining = (total_combos - num_completed)*FOCUS_SLEEP_SECONDS*2
